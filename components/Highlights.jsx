...
import { MapPin, Building, LayoutDashboard, Home, Activity, TrendingUp } from 'lucide-react'
...
const highlightsData = [
  {
    ...
    desc: 'Devanahalli Aerospace Park Phase 2 is a fast-developing hub close to the airport, highways, and upcoming infrastructure projects.',
  },
  {
    icon: Building,
    title: 'World Trade Center Advantage',
    desc: "Bengaluru's second WTC will attract global businesses, significantly boosting rental demand and overall investment value.",
  },
  {
    icon: LayoutDashboard,
    title: 'Integrated Township',
    desc: 'A self-contained ecosystem spanning 75 acres with premium residential, commercial, and retail spaces in one vibrant place.',
  },
  {
    icon: Home,
    title: 'Functionality & Elegance',
    desc: 'Homes crafted to provide absolute privacy while encouraging a sense of community, offering multiple functional layout options.',
  },
  {
    icon: Activity,
    title: 'Modern Resort Amenities',
    desc: 'A vast array of world-class facilities including a grand clubhouse and sports arenas for a comfortable and enriching lifestyle.',
  },
  {
    icon: TrendingUp,
    title: 'Trusted Legacy & Returns',
    desc: "Backed by Brigade Group's legacy of quality and timely delivery, ensuring strong appreciation potential in the long run.",
  },
]
