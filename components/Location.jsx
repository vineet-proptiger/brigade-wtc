...
const locationLandmarks = [
  { name: 'Kempegowda International Airport', dist: 'Close By' },
  { name: 'Devanahalli Railway Station', dist: 'Nearby' },
  { name: 'Bus stands', dist: 'Easily Accessible' },
  { name: 'Leading hospitals', dist: 'Nearby' },
  { name: 'Emergency services', dist: 'Easily Accessible' },
  { name: 'Reputed schools', dist: 'In the vicinity' },
  { name: 'Colleges', dist: 'Short drive' },
]
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-stretch">
          ...
          <div className="w-full lg:flex-1 lg:order-1 flex flex-col justify-center" data-aos="fade-right" data-aos-duration="1000">
            <div style={{
              ...
              <iframe 
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3883.9441086489765!2d77.7014679!3d13.2288242!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae1d00015e6f97%3A0x62fe67929731f066!2sDevanahalli%20Bangalore!5e0!3m2!1sen!2sin!4v1790337285909!5m2!1sen!2sin" 
