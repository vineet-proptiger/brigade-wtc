        ...
        {slides.map((slide, index) => (
          ...
          >
            <div className="desktop-img-wrapper w-full h-full">
              <Image
                src={slide.img}
                alt={`Brigade WTC Devanahalli Banner ${index + 1}`}
                width={1920}
                height={800}
            ...
            {slide.mobileImg && (
              <div className="mobile-img-wrapper w-full h-full">
                <Image
                  src={slide.mobileImg}
                  alt={`Brigade WTC Devanahalli Mobile Banner ${index + 1}`}
                  width={768}
                  height={900}
      ...
      <div className="hero-content">
        ...
        <p className="hero-subtitle">
          <span className="hero-subtitle-badge" style={{ fontSize: '0.9em', fontWeight: 600, textTransform: 'none' }}>
            At KIADB Phase 2 Devanahalli, North Bengaluru.
          </span>
        </p>
        ...
        <div className="hero-bullets" style={{ marginBottom: '24px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
          {[
            "75 Acre development in KIADB Phase 2",
            "7,195 Residential Units Across 16 Modern Blocks",
            "High-Rise Towers Rising Up to G+30 Floors",
        ...
        <p className="hero-price-line w-full text-center lg:text-left" style={{ marginBottom: '0px' }}>
          <span className="hero-price-title whitespace-nowrap">
            Luxury 1, 1.5, 2 & 3 BHK Residences Starting From
          </span>
