const stats = [
  { value: 'Pre-Launch', label: 'Upcoming integrated mixed-use township', icon: (
  ...
  { value: '75 Acres', label: 'Sprawling township with 16 blocks', icon: (
    <svg className="w-8 h-8 text-[#B88A44]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  { value: 'Aerospace Park Phase 2', label: 'Devanahalli, North Bengaluru', icon: (
    <svg className="w-8 h-8 text-[#B88A44]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path>
    </svg>
  ) },
  { value: 'RERA Under Process', label: 'Registration currently in progress', icon: (
    <svg className="w-8 h-8 text-[#B88A44]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
